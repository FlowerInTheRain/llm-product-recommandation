...
You can then execute your native executable with: `./target/llm-product-assistance-1.0-SNAPSHOT-runner`
...
- LangChain4j Mistral AI ([guide](https://docs.quarkiverse.io/quarkus-langchain4j/dev/index.html)): Provides integration
  of Quarkus LangChain4j with Mistral AI
